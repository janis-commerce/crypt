...
const autogenWarning = `<!-- This file is autogenerated. Do not change manually.
...
for(const moduleName of moduleNames) {
	const template = `${autogenWarning}{{#module name="${moduleName}"}}{{>docs}}{{/module}}`;
	const output = jsdoc2md.renderSync({ data: templateData, template });
	fs.writeFileSync(path.resolve(outputDir, `${moduleName}.md`), output);
}

const indexPage = `${autogenWarning}See documentation for each module:
